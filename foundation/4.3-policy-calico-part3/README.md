...
In Lab4.2, we have applied a policy that allows all pod access. Here we will implement a more restrictive policy that allows minimal access and denies everything else.
